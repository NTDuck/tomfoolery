...
public class CloudAdministratorRepositoryTest extends BaseUnitTest<CloudAdministratorRepository> {
    ...
    public void setUp() {
        ...
        this.testSubject.delete(sampleUser.getId());
    }

    @Test
    public void WhenSavingUser_ExpectUserToExist() {
        this.testSubject.save(sampleUser);

        val retrievedUser = this.testSubject.getById(sampleUser.getId());
    ...
    public void WhenRetrievingUserByUsername_ExpectMatchingUser() {
        val retrievedUser = this.testSubject.getByUsername(sampleUser.getCredentials().getUsername());
    ...
    public void WhenListingUsers_ExpectNonEmptyList() {
        ...
        val users = this.testSubject.show();
